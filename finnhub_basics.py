...
# r = requests.post('https://finnhub.io/api/v1/webhook/add?token=bta0vr748v6rm8019cbg', json={'event': 'earnings', 'symbol': 'AAPL'})
# res = r.json()
# print(res)
...
# Stock symbols
all_us_symbols = finnhub_client.stock_symbols('US')
df = pd.DataFrame(all_us_symbols)
df.to_excel("./data/Supported_API_Companies.xlsx")
